...
echo "<a href='birja.php'>Биржа труда</a><br>";
echo "<a href='colledj.php'>Колледж</a><br>";
echo "<a href='trade.php'>Торговля</a><br>";
echo "<a href='cosmoport.php'>Космодром</a><br>";
echo "<a href='bank.php'>Банк</a>";
